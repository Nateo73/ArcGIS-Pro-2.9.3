...
in_layer =  aprxMap.listLayers("CLU_ks*")
...
def alterfields():
    try:
        ...
        arcpy.AlterField_management(layer,field1,newfield1,nalias,new_type,new_length,new_is_nullable)
        arcpy.AlterField_management(layer,field2,nfield2,nalias2,new_type,new_length,new_is_nullable)
        arcpy.AlterField_management(layer,field3,nfield3,nalias3,new_type,nlength3,new_is_nullable)
...
def addRemoveFields():
    try:
        ...
        arcpy.management.AddFields(layer,add_fields)
        arcpy.DeleteField_management(layer,drop_fields)
        arcpy.CalculateField_management(layer,"tract","$feature.tract_number","ARCADE")
        arcpy.DeleteField_management(layer,"tract_number")
...
def appendCLU():
    try:
        ...
        arcpy.Append_management(layer,appLayer,"TEST")
...
def addGlobalID():
    try:
        arcpy.management.AddGlobalIDs(layer)
