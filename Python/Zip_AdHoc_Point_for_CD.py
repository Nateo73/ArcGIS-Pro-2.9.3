...
# Create temp folder
arcpy.management.CreateFolder(r"C:\geodata\project_data\nrcs\tools\ArcGIS_Pro_Utilities\Export_Files", "shp_temp_point")

# Define variables
inFeatures = "Local Temp Layers\\AdHoc_Point"
...
if outNameLen>22:
    outName = userInput[0:21] + "_p"
else:
    outName = userInput + "_p"    

# Export AdHoc_Point to shapefile
