...
##        outputWS = r'I:\scratch\scratch.gdb'
        ...
        renameend = renametime.replace(" ","_")
        renamenocolon = renameend.replace(":","_")
        ...
        ksclu = arcpy.Rename_management(newCLUfc,"CLU_ks_" +renamenocolon + os.path.basename(AOI))
        
        #AddMsgAndPrint("\nThere are " + splitThousands(arcpy.GetCount_management(cluFC)[0]) + " CLUs in your AOI.  Done!\n")
        AddMsgAndPrint("\nThere are " + splitThousands(arcpy.GetCount_management(ksclu)[0]) + " CLUs in your AOI.  Done!\n")
