...
# Create temp folder
arcpy.management.CreateFolder(r"C:\geodata\project_data\nrcs\tools\ArcGIS_Pro_Utilities\Export_Files", "shp_temp_LandUnit")

# Define variables
inFeatures = "Local Temp Layers\\Land Units"
...
if outNameLen>22:
    outName = userInput[0:21] + "_LU"
else:
    outName = userInput + "_LU"    

# Export Land Units to shapefile
