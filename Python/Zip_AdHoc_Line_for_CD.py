...
# Create temp folder
arcpy.management.CreateFolder(r"C:\geodata\project_data\nrcs\tools\ArcGIS_Pro_Utilities\Export_Files", "shp_temp_line")

# Define variables
inFeatures = "Local Temp Layers\\AdHoc_Line"
...
if outNameLen>22:
    outName = userInput[0:21] + "_l"
else:
    outName = userInput + "_l"    

# Export AdHoc_Line to shapefile
